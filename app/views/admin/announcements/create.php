    ...
    <div class="ml-64 mt-16 p-6">
        <div class="max-w-4xl mx-auto">
            <div class="flex justify-between items-center mb-6">
                <div>
                    <h1 class="text-2xl font-semibold text-gray-900">Créer une Annonce</h1>
                    <p class="mt-1 text-sm text-gray-600">Remplissez les informations pour créer une nouvelle annonce</p>
                </div>
